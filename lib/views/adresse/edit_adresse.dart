...
class AdresseEditPage extends StatefulWidget {
  AdresseEditPage(
      {super.key, required this.uIdentifiant, required this.uneAdresse});
  String uIdentifiant;
  Adresse uneAdresse;
  @override
  State<AdresseEditPage> createState() => _AdresseEditPageState();
}

class _AdresseEditPageState extends State<AdresseEditPage> {
  ...
  void initState() {
    ...
    super.initState();
    _name.text = widget.uneAdresse.nomAdresse!;
    _description.text = widget.uneAdresse.description!;
    lat = double.parse(widget.uneAdresse.latitude!);
    long = double.parse(widget.uneAdresse.longitude!);
    _focus.requestFocus();
  }
  ...
  _updateadress() async {
    ...
    if (isConnect) {
      final Map<String, String> dataAdresse = {
        ...
        'a_identifiant': widget.uneAdresse.keyAdresse!,
      };

      UneAdresseResponse responseAdresse =
          await ApiRepository.updateAdresse(dataAdresse);
      Navigator.pop(context);
